...
public class ClientImpl implements IClient {
    ...
    private static final String SEARCH_BY_MATRICULE = "SELECT * FROM Clients WHERE code LIKE ?";
    private static final String SEARCH_BY_LASTNAME= "SELECT * FROM Clients WHERE prenom LIKE ?";
