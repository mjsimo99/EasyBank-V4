...
import com.majidim.easybankv4.easybankv4.interfeces.IDemendeCredit;
    ...
    public List<DemendeCredit> SearchByagency(Agence agence) {
        ...
        try (PreparedStatement preparedStatement = connection.prepareStatement(SEARCH_BY_AGENCY)) {
            ...
            while (resultSet.next()) {
                ...
                creditRequest.setEmploye(new Employe(resultSet.getString("employe_matricule"),null));
                creditRequest.setClient(new Client(resultSet.getString("client_code")));
